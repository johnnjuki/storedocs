...
export const Header = ({ className, user, ...props }: HeaderProps) => {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 flex h-20 w-full items-center border-b border-b-transparent backdrop-blur-2xl duration-200 ",
    ...
    >
      <div className="mx-auto flex w-full max-w-screen-lg items-center justify-between px-4 md:px-8">
        <Link href="/">
          <div className="font-bold text-2xl md:text-3xl ">Storedocs</div>
        </Link>
